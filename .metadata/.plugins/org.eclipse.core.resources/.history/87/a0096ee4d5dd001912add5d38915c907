...
<body>
    ...
    <form action="saveOrUpdate" method="post">
	    <ul class="forminfo">
	    <input name="user.userId" type="hidden" value="${user.userId}" /> 
	    <li><label>账号</label>
	    	<input name="userName" type="text" class="dfinput" value="${user.userName}"/>
	    	<i></i>
	    </li>
	    <li><label>姓名</label>
	    	<input name="realName" type="text" class="dfinput" value="${user.realName}"/>
	    	<i></i></li>
	    ...
	    <li><label>邮箱</label>
	    	...
	    	<i></i></li>
	    <li><label>电话</label>
	    	<input name="phone" type="text" class="dfinput"  value="${user.phone}"/>
	    	<i></i></li>
