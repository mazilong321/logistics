...
<body>
    ...
    <div class="tools">
    	...
    	<ul class="toolbar">
		<li class="click"><span> 
			<a href="${pageContext.request.contextPath}/user/goAddOrUpdate">
				<img src="${pageContext.request.contextPath}/images/t01.png" /></span>添加
			</a>
		</li>
    ...
    <table class="tablelist">
        ...
        <th>角色编号<i class="sort"><img src="${pageContext.request.contextPath}/images/px.gif" /></i></th>
        <th>角色名称</th>
        <th>角色描述</th>
        <th>操作</th>
        </tr>
