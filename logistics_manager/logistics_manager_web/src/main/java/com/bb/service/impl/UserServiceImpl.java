...
public class UserServiceImpl implements IUserService {
	...
	//新增用户权限
	@Override
	public void insertUserAndRoles(List<UserRoleKey> list){
		// TODO Auto-generated method stub
		for(UserRoleKey userRoleKey: list) {
			System.out.println(userRoleKey);
			this.insertUserAndRole(userRoleKey);
		}
	}
	//新增用户
	@Override
	...
	@Override
	public void insertUserAndRole(UserRoleKey userRoleKey) {
		// TODO Auto-generated method stub
		userMapper.insertUserAndRole(userRoleKey);
	}
